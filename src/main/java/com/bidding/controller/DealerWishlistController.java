        ...
        List<InspectionSummaryResponse> wishlistVehicles = inspectionRepository.findAllById(wishlistInspectionIds).stream()
                .map(ins -> {
                    ...
                    return InspectionSummaryResponse.builder()
                            ...
                            .currentHighestBid(inspectionService.resolveCurrentHighestBid(v, ins.getId()))
                            .currentHighestBidder(inspectionService.resolveCurrentHighestBidder(v, ins.getId()))
